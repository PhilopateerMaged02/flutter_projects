...
import 'package:news_app/modules/NewsApp/web_view/web_view_screen.dart';
...
})
{
  return ConditionalBuilder(
    ...
    builder: (context) => ListView.separated(
        ...
        separatorBuilder: (context, index) => Container(width: double.infinity, height: 3,color: Colors.grey[200],),
        itemCount: l.length),
...
{
  return  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => widget,
  ) ,
  (route) => false,);
}
void showToust({
